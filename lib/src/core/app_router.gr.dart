...
import 'package:flutter_skeleton/src/feature/category/screens/category_list_screen.dart'
    as _i11;
import 'package:flutter_skeleton/src/feature/home/home_screen.dart' as _i9;
...
class AppRouter extends _i8.RootStackRouter {
  ...
  final Map<String, _i8.PageFactory> pagesMap = {
    ...
    UpdatePasswordScreenRoute.name: (routeData) {
      ...
      return _i8.AdaptivePage<dynamic>(
          routeData: routeData,
          child: _i6.UpdatePasswordScreen(key: args.key, token: args.token));
    },
    ...
    PlaceholderScreenRoute.name: (routeData) {
      return _i8.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i10.PlaceholderScreen());
    },
    CategoryListScreenRoute.name: (routeData) {
      return _i8.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i11.CategoryListScreen());
    },
    UserListScreenRoute.name: (routeData) {
      return _i8.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i12.UserListScreen());
    },
    ProfileScreenRoute.name: (routeData) {
      ...
      return _i8.AdaptivePage<dynamic>(
          routeData: routeData,
          child: _i13.ProfileScreen(key: args.key, uuid: args.uuid));
    }
  };

  @override
  List<_i8.RouteConfig> get routes => [
        _i8.RouteConfig(AuthLandingScreenRoute.name, path: '/'),
        _i8.RouteConfig(LoginScreenRoute.name, path: '/login'),
        _i8.RouteConfig(RegisterScreenRoute.name, path: '/register'),
        _i8.RouteConfig(TwoFactorConfirmationScreenRoute.name,
            path: '/confirm/phone-number'),
        _i8.RouteConfig(SettingsScreenRoute.name, path: '/settings'),
        _i8.RouteConfig(UpdatePasswordScreenRoute.name,
            path: '/update-password/:token'),
        _i8.RouteConfig(DashboardContainerRoute.name,
            path: '/dashboard',
            children: [
              _i8.RouteConfig('#redirect',
                  ...
                  redirectTo: '/tab1',
                  fullMatch: true),
              _i8.RouteConfig(HomeTabRouter.name,
                  path: 'home',
                  parent: DashboardContainerRoute.name,
                  children: [
                    _i8.RouteConfig(HomeScreenRoute.name,
                        path: '', parent: HomeTabRouter.name),
                    _i8.RouteConfig(PlaceholderScreenRoute.name,
                        path: 'placeholder', parent: HomeTabRouter.name)
                  ]),
              _i8.RouteConfig(CategoryTabRouter.name,
                  path: 'categories',
                  parent: DashboardContainerRoute.name,
                  children: [
                    _i8.RouteConfig(CategoryListScreenRoute.name,
                        path: '', parent: CategoryTabRouter.name)
                  ]),
              _i8.RouteConfig(UsersTabRouter.name,
                  path: 'users',
                  parent: DashboardContainerRoute.name,
                  children: [
                    _i8.RouteConfig(UserListScreenRoute.name,
                        path: '', parent: UsersTabRouter.name),
                    _i8.RouteConfig(ProfileScreenRoute.name,
...
class AuthLandingScreenRoute extends _i8.PageRouteInfo<void> {
...
class TwoFactorConfirmationScreenRoute extends _i8.PageRouteInfo<void> {
...
/// generated route for
/// [_i6.UpdatePasswordScreen]
class UpdatePasswordScreenRoute
    extends _i8.PageRouteInfo<UpdatePasswordScreenRouteArgs> {
  UpdatePasswordScreenRoute({_i14.Key? key, required String token})
...
class DashboardContainerRoute extends _i8.PageRouteInfo<void> {
  const DashboardContainerRoute({List<_i8.PageRouteInfo>? children})
...
/// generated route for
/// [_i8.EmptyRouterPage]
class CategoryTabRouter extends _i8.PageRouteInfo<void> {
  const CategoryTabRouter({List<_i8.PageRouteInfo>? children})
...
/// generated route for
/// [_i8.EmptyRouterPage]
class UsersTabRouter extends _i8.PageRouteInfo<void> {
  const UsersTabRouter({List<_i8.PageRouteInfo>? children})
...
class PlaceholderScreenRoute extends _i8.PageRouteInfo<void> {
...
/// generated route for
/// [_i11.CategoryListScreen]
class CategoryListScreenRoute extends _i8.PageRouteInfo<void> {
...
/// generated route for
/// [_i12.UserListScreen]
class UserListScreenRoute extends _i8.PageRouteInfo<void> {
...
class ProfileScreenRoute extends _i8.PageRouteInfo<ProfileScreenRouteArgs> {
  ProfileScreenRoute({_i14.Key? key, required String uuid})
